...
import com.ommagdum.tickets.exceptions.EventUpdateException;
import com.ommagdum.tickets.exceptions.TicketTypeNotFoundException;
import com.ommagdum.tickets.exceptions.UserNotFoundException;
import com.ommagdum.tickets.repositories.EventRepository;
...
public class EventServiceImpl implements EventService {
    ...
    public Event updateEventForOrganizer(UUID organizerId, UUID id, UpdateEventRequest event) {
        ...
        Event existingEvent = eventRepository.findByIdAndOrganizerId(id, organizerId)
                .orElseThrow(() -> new EventNotFoundException(String.format("Event eith ID '%s' does not exits", id)));
        ...
        existingEvent.setSalesStart(event.getSaleEnd());
        ...
        for (UpdateTicketTypeRequest ticketType: event.getTicketTypes()) {
            if(null == ticketType.getId()) {
                ...
                throw new TicketTypeNotFoundException(String.format("Ticket Type with ID '%s' does not exists", ticketType.getId()));
            }
        }
